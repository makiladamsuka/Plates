...
export function Login() {
  ...
  useEffect(() => {
    // Whenever tab regains focus, app is resumed, or any interaction occurs, reset spin
  ...
  const handleGoogleLogin = async (e: React.MouseEvent) => {
    ...
    try {
      ...
      // Brief 1-second pulse feedback only - never permanently lock or freeze button state
      if (spinTimerRef.current) clearTimeout(spinTimerRef.current);
